...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        alien.addImage(new Filename("thanos","jpg"),new Image("thanos",100,180));
        alien.addImage(new Filename("gauntlet","jpg"),new Image("thanos with gauntlet",100,180));
        // images is a set, so this will not be added
        alien.addImage(new Filename("thanos","jpg"),new Image("thanos",100,180));
