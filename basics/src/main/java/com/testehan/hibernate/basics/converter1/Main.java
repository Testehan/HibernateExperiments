...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration().configure().addAnnotatedClass(Alien.class).addAnnotatedClass(MonetaryAmountConverter.class);
        ...
        alien.setAlienSalary(new MonetaryAmount(1000, Currency.getInstance("USD")));
